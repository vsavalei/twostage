...
compared to the approach where composites are computed directly, and a model is fit to them. The composites are always sums or averages of the items; the weights are all equal and are fixed rather than estimated. 
