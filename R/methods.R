...
# fitMeasures for PIM?
# Stick with ordinary function unless there are multiple methods that need PIM-specific behavior. The subclass approach adds complexity for limited benefit if we only need to modify fit measure
# # Create subclass
...
setMethod("show", "twostage", function(object) {
  # Capture output while suppressing direct printing
  ...
  # Find and modify the test statistic line to maintain alignment
